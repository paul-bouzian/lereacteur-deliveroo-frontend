...
function App() {
  ...
  return loading ? (
    <div className="flex h-full items-center justify-center">
      <button
        type="button"
        className="flex items-center gap-6 rounded-xl bg-emerald-600 p-2 text-white"
        disabled
      >
        <svg
          aria-hidden="true"
          className="h-8 w-8 animate-spin fill-emerald-400 text-gray-200 dark:text-gray-600"
          viewBox="0 0 100 101"
          fill="none"
